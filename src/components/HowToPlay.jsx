...
function HowToPlay({ onClose }) {
  return (
    <div className="modal-overlay" onClick={onClose}>
      <div
        className="modal howtoplay-modal"
      ...
      >
        ...
        <div className="howtoplay-section">
          ...
          <div className="howtoplay-roles">
            <div className="howtoplay-role howtoplay-role-gold">
              <strong>BADSHAH</strong> - The King. Decides the WAZIR and asks
              the question.
            </div>
        ...
        <div className="howtoplay-section">
          ...
          <ol>
            ...
            <li>
              Privately assign player numbers (folded slips, hat draw, etc.)
            </li>
            <li>Each player enters their secret player number</li>
            <li>
              Tap &quot;Reveal My Role&quot; — hide your screen from others!
            </li>
          </ol>
        </div>
        ...
        <div className="howtoplay-section">
          ...
          <div className="howtoplay-scoring">
            <div>
              WAZEER finds CHOR: WAZEER +5, BADSHAH +3, SIPAHI +1, CHOR +0
            </div>
